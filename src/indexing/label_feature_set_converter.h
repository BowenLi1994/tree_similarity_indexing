...
namespace label_feature_set_converter {
...
public:
  ...
  struct LabelSetElementcomparator {
    bool operator()(const label_feature_set_converter::LabelSetElement& a, 
                    const label_feature_set_converter::LabelSetElement& b) const { 
      return a.id < b.id; 
    }
...
#include "label_feature_set_converter_impl.h"
