...
int main(int, char** argv) {
    ...
    ted_join_indexing_algorithm.execute_feature_join_rn(trees_collection,sets_collection,distance_collection ,candidates,join_result,(double)threshold);
    ...
    std::string filepath="/home/bowen/tree_similarity_indexing/result/fjoin_rn_compararions.txt";
    ...
    std::string filepath2="/home/bowen/tree_similarity_indexing/result/fjoin_rn_time.txt";
